...
class _HomePageState extends State<HomePage> {
  ...
  if (googleAccessToken != null) {
    final revokeUrl = 'https://oauth2.googleapis.com/revoke?token=$googleAccessToken';
    try {
  ...
  final keycloakLogoutUrl = '${Config.server}:8080/realms/G-SSO-Connect/protocol/openid-connect/logout';
...
void _clearGoogleCookies() {
  ...
  for (var cookie in cookies) {
    html.document.cookie = "$cookie=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/; domain=accounts.google.com;";
  }
}
